# -*- coding: utf-8 -*-
#
# Copyright (c) 2014-2015 by Ecreall under licence AGPL terms,
...
def test_tous_les_jours:
    for v,r in test_data_tous_les_jours:
        assert french_dates_to_ical.main(v) == r

def test_tous_les_jours_a:
    for v,r in test_data_tous_les_jours_a:
        assert french_dates_to_ical.main(v) == r
